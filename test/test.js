suite("test", function() {
    ...
    test("without configuration - 1", function(done) {
        require(["ioc!Obj5"], function(obj) {
            expect(obj).to.be.a("object");
    ...
    test("without configuration - 2", function(done) {
        require(["ioc!Obj5"], function(obj) {
            expect(obj).to.be.a("object");
            expect(obj.a).to.equal("a");
            expect(obj.b).to.equal("b");
            expect(obj.string).to.equal("string2");
            done();
        }, done);
    });

    test("without configuration - 3", function(done) {
        require(["ioc!Obj5|prototype"], function(obj) {
            expect(obj).to.be.a("object");
            expect(obj.a).to.equal("a");
            expect(obj.b).to.equal("b");
            expect(obj.string).to.equal("string");
